...
class StudentClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_class" do
    assert_difference('StudentClass.count') do
      post student_classes_url, params: { student_class: { class_number: @student_class.class_number, teacher1: @student_class.teacher1, teacher2: @student_class.teacher2 } }
    end
  ...
  test "should update student_class" do
    patch student_class_url(@student_class), params: { student_class: { class_number: @student_class.class_number, teacher1: @student_class.teacher1, teacher2: @student_class.teacher2 } }
